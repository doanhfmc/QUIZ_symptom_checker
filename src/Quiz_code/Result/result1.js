...
import icon from '../../img/icon_demo.png'
  ...
  return (
    <div className="symptom-checker">
      ...
      <section className="result">
        ...
        <button className="find-out-button">FIND OUT ABOUT CAUSE & TREATMENT</button>
      </section>
      ...
      <section className="slider">
        ...
        <div className="slider-container">
          ...
          <div className="slide">
            <img src={sliderData[currentSlide].img} alt={sliderData[currentSlide].title} />
