    ...
    >
      ...
      >
        ...
        <p style={{ fontWeight: "bold", fontSize: "14px" }}>
          70-75% phụ nữ trong độ tuổi sinh sản mắc bệnh hiễm nấm âm đạo ít nhất
          một lần trong đời. Việc điều trị có thể khó khăn vì 40-45% bệnh nhân
          bị tái phát ít nhất 1 lần/năm và 5-8% phát triển thành viêm âm đạo dai
          dẳng (≥ 4 lần/năm).
        </p>
        <p style={{ fontSize: "12px", marginTop: "10px" }}>
          2. Zeng et al. Biomed Research International. 2018; 9703754 <br /> 3.
